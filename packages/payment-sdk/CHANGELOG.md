...
- 1a7180d: `clearTossPayments` 가 default URL 뿐 아니라 `loadTossPayments` 가 시도한 모든 src 의 스크립트를 정확히 제거하도록 수정합니다. 패키지 모듈 내부에 (src, namespace) 추적 state 를 두어, custom `src` 로 load 한 케이스에서도 자연스럽게 해당 스크립트와 sdk-loader 의 cache entry 가 함께 정리됩니다.
...
## [1.9.1](https://github.com/tosspayments/browser-sdk/compare/@tosspayments/payment-sdk@1.9.0...@tosspayments/payment-sdk@1.9.1) (2024-11-13)

### Bug Fixes

- @tosspayments/payment\_\_types 버전업 ([#127](https://github.com/tosspayments/browser-sdk/issues/127)) ([30e39a4](https://github.com/tosspayments/browser-sdk/commit/30e39a4dec2ceec685c835aadd95b7442c2f75b4))
...
- **payment-sdk:** 내부 타입 추론 오류 수정 ([#86](https://github.com/tosspayments/browser-sdk/issues/86)) ([96519f5](https://github.com/tosspayments/browser-sdk/commit/96519f579e97fd46e6c3dd071e21202f60c169ee))
